...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "page_blocks_steps_items" ADD COLUMN "description" varchar;
  ALTER TABLE "_page_v_blocks_steps_items" ADD COLUMN "description" varchar;
  ALTER TABLE "post_blocks_steps_items" ADD COLUMN "description" varchar;
  ALTER TABLE "_post_v_blocks_steps_items" ADD COLUMN "description" varchar;
  ALTER TABLE "guide_blocks_steps_items" ADD COLUMN "description" varchar;
  ALTER TABLE "_guide_v_blocks_steps_items" ADD COLUMN "description" varchar;`)
}
